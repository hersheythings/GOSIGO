...
근데 어차피 내 특성상 또 다른 곳으로 눈을 돌릴 가능성이 매우 큼. 따라서 대학 졸업 전까지 진행할 장기 프로젝트가 되어야 할 듯.
...
## 배경
일단 그냥 심심하고 내가 직접 만들면서 개발 좀 배울겸 ㅇㅇ
...
3. 나무경영, 위너스, 우리 (이른바 우나위) 3사는 앱 개발에는 리소스를 쏟지도 않고, 그럴 필요도 없음. 학원 비즈니스이기 때문에 전문 앱 서비스를 제공할 유인은 많지 않음. 
